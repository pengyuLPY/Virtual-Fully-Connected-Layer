...
class DictArcMarginProduct(nn.Module):
    def __init__(self, in_features=128, out_features=200, out_features_test=74974, s=32.0, m=0.50, label_dict=None, easy_margin=False):
...
class DictArcMarginProduct_Reweight(nn.Module):
    def __init__(self, in_features=128, out_features=200, out_features_test=74974, s=32.0, m=0.50, label_dict=None, easy_margin=False, n_sample=4):
